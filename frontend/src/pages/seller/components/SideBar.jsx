    ...
    return (
        <>
            <React.Fragment>
                ...
                >
                    <ListItemIcon>
                        <WidgetsIcon sx={{ color: (location.pathname === "/" || location.pathname === "/Seller/dashboard") ? '#0d6e18' : 'inherit' }} />
                    </ListItemIcon>
                ...
                >
                    <ListItemIcon>
                        <ShoppingCartIcon sx={{ color: location.pathname.startsWith('/Seller/products') ? '#0d6e18' : 'inherit' }} />
                    </ListItemIcon>
                ...
                >
                    <ListItemIcon>
                        <PendingActionsIcon sx={{ color: location.pathname.startsWith("/Seller/orders") ? '#0d6e18' : 'inherit' }} />
                    </ListItemIcon>
                ...
                </ListItemButton>
                {
                    ...
                    >
                        <ListItemIcon>
                            <AdminPanelSettingsIcon sx={{ color: location.pathname.startsWith("/Seller/shopcart") ? '#0d6e18' : 'inherit' }} />
                        </ListItemIcon>
            ...
            <React.Fragment>
                ...
                >
                    <ListItemIcon>
                        <AccountCircleIcon sx={{ color: location.pathname.startsWith("/Seller/profile") ? '#0d6e18' : 'inherit' }} />
                    </ListItemIcon>
                ...
                >
                    <ListItemIcon>
                        <LogoutIcon sx={{ color: location.pathname.startsWith("/logout") ? '#0d6e18' : 'inherit' }} />
                    </ListItemIcon>
